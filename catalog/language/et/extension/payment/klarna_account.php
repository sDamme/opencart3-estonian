<?php
// Text
$_['text_title']				= 'Klarna Konto - Maksa alates %s/kuus';
...
$_['text_information']			= 'Klarna Konto teave';
$_['text_additional']			= 'Klarna Konto vajab täiendavat teavet enne, kui nad saavad teie tellimust töödelda.';
$_['text_male']					= 'Mees';
$_['text_female']				= 'Naine';
$_['text_year']					= 'Aasta';
$_['text_month']				= 'Kuu';
$_['text_day']					= 'Päev';
$_['text_payment_option']		= 'Maksevalikud';
$_['text_single_payment']		= 'Üksikmakse';
$_['text_monthly_payment']		= '%s - %s kuus';
$_['text_comment']				= 'Klarna arve ID: %s' . "\n" . '%s/%s: %.4f';
$_['text_terms_description']    = 'Olen nõus, et Klarnale edastatakse arveostu teostamiseks ning isiku- ja krediidikontrolliks vajalikud andmed. Oma <a href="https://online.klarna.com/consent_de.yaws" target="_blank">nõusoleku</a> võin ma igal ajal tulevikus kehtetuks tunnistada.';
...
$_['error_address_match']		= 'Arveldus- ja saatmisaadress peavad ühtima, kui soovite kasutada Klarna makseid';
